...
<html>
    <head>
        ...
        <title>Mobile Repairing Records</title>
    </head>
    <body>
        <hr>
        ...
        <br>
        <p align="center">Mobile Repairing Records</p>
        <hr>
       <table class="table table-dark table-hover">  
        ...
        try{
            ...
            firstdate=request.getParameter("t1");
            lastdate=request.getParameter("t2");
            ...
            String sql="select * from MobileRepairing where dates BETWEEN ? and ?";
